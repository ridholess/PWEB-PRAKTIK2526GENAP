...
<body class="min-h-screen flex flex-col">
    ...
    <main class="flex-1 px-6 py-10 max-w-6xl mx-auto w-full">
        ...
        <div class="flex items-center justify-between gap-4 mb-2">
            <h1 class="text-3xl font-black italic tracking-widest text-black flex items-center gap-3">
                Data Mahasiswa 
                <span class="bg-[#000] text-white text-xs font-medium italic px-3 py-1.5 rounded-md shadow-[2px_2px_0px_#E8715A] align-middle">Week-9</span>
            </h1>
            <a href="logout.php"
                class="bg-[#000] text-white text-xs font-bold px-4 py-2 rounded-md shadow-[2px_2px_0px_#E8715A] hover:shadow-[0px_0px_0px] transition-all duration-200 no-underline inline-block">
                Logout
            </a>
        </div>
